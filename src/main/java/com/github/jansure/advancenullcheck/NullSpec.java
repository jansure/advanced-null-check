...
/**
 *
 * {@link NullSpec} protects any Object from null arguments. After the
 * enhancement, a NullPointerException will raise automatically if any null
 * argument is detected.
 *
 */
public final class NullSpec {

  private NullSpec() {}

  /**
   *
   * {@link NullSpec}.{@link Constructor} is a builder which is designed to
   * make a nullspec instance easier.
   *
   * <P>
   * For example:<br>
   *
  ...
  public static class Constructor<E> {
    ...
    /**
     * Returns a {@link NullSpec.Constructor}.
     *
     * @param klass
    ...
    /**
     * Creates a nullcheck instance of given Class.
     *
     * @return a nullcheck instance of given Class
     */
    public E create() {
      return of(klass,
  ...
  public static <E> E of(Class<E> klass) {
    return Guice.createInjector(new NonNullSpec()).getInstance(klass);
  }
  ...
  public static <E> E of(final Class<E> klass, final TypeLiteral<?>[] types,
                         final Object... args) {
    return Guice.createInjector(new NonNullSpec(), new AbstractModule() {
